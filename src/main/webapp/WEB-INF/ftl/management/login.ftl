...
<div class="container ">
    <nav class="navbar navbar-light bg-white shadow">
        <ul class="nav">
            <li class="nav-item">
                <a href="/">
                    <img src="/images/myIconSmall.png" class="mt-1"
                         style="width: 100px">
                </a>
            </li>
        </ul>
    ...
    $("#btnSubmit").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.info(data);
                if (data.code == "0") {
                    window.location = "/management/?ts=" + new Date().getTime(); //防止浏览器缓存，加入时间戳
                } else {
